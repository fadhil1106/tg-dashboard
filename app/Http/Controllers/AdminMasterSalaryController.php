...
class AdminMasterSalaryController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->col[] = ["label" => "Salary TI", "name" => "salary_ti", "callback" => function ($row) {
            return number_format($row->salary_ti);
        }];
        $this->col[] = ["label" => "Salary TM", "name" => "salary_tm", "callback" => function ($row) {
        ...
        $this->form[] = ['label' => 'Salary Tiran Indonesia', 'name' => 'salary_ti', 'type' => 'number', 'validation' => 'min:0', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Salary Tiran Mineral', 'name' => 'salary_tm', 'type' => 'number', 'validation' => 'min:0', 'width' => 'col-sm-10'];
